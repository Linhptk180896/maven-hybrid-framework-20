...
//
//public class Level15_ReportExtendV2 extends BaseTest{
//	WebDriver driver;
...
//		
//		ExtentManagerV2.getTest().log(LogStatus.INFO, "Register - Step 02: Enter to First Name Textbox with value = " + firstName);
////		log.info("Register - Step 02: Enter to First Name Textbox with value = " + firstName);
//		registerPage.inputToFirstNameTextbox(firstName);
//		
//		ExtentManagerV2.getTest().log(LogStatus.INFO, "Register - Step 03: Enter to Last Name Textbox with value = " + lastName);
////		log.info("Register - Step 03: Enter to Last Name Textbox with value = " + lastName);
//		registerPage.inputToLastNameTextbox(lastName);
//		
//		
//		ExtentManagerV2.getTest().log(LogStatus.INFO, "Register - Step 04: Enter to Existing Email Textbox with value = " + existingEmail);
////		log.info("Register - Step 04: Enter to Existing Email Textbox with value = " + existingEmail);
//		registerPage.inputToEmailTextbox(existingEmail);
//		
//		
//		ExtentManagerV2.getTest().log(LogStatus.INFO, "Register - Step 05: Enter to password Textbox with value = " + password);
////		log.info("Register - Step 05: Enter to password Textbox with value = " + password);
//		registerPage.inputToPasswordTextbox(password);
//		
//		
//		ExtentManagerV2.getTest().log(LogStatus.INFO, "Register - Step 06: Enter to confirm password  Textbox with value = " + password);
...
//		
//		
//		ExtentManagerV2.getTest().log(LogStatus.INFO, "Register - Step 08: Verify register success message is displyed");
...
//		ExtentManagerV2.getTest().log(LogStatus.INFO, "Login - Step 01: Navigate to open login page");
////		log.info("Login - Step 01: Navigate to open login page");
//		loginPage =	homePage.openLoginPage();
//		
//		
//		ExtentManagerV2.getTest().log(LogStatus.INFO, "Login - Step 02: Enter to Email Textbox with value = " + existingEmail);
////		log.info("Login - Step 02: Enter to Email Textbox with value = " + existingEmail);
//		loginPage.inputToEmailTextbox(existingEmail);
//		
//		
//		
//		ExtentManagerV2.getTest().log(LogStatus.INFO, "Login - Step 03: Enter to Password Textbox with value = " + password);
////		log.info("Login - Step 03: Enter to Password Textbox with value = " + password);
//		loginPage.inputToPasswordTextbox(password);
//		
//		
//		
//		ExtentManagerV2.getTest().log(LogStatus.INFO, "Login - Step 04: Click on Login Button");
...
//		
//		
//		ExtentManagerV2.getTest().log(LogStatus.INFO, "Login - Step 07: Verify CustomerInfoPage is Displayed");
