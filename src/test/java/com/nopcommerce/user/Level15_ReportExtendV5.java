...
public class Level15_ReportExtendV5 extends BaseTest{
	WebDriver driver;
...
//		log.info("Register - Step 01: Navigate to Register Page");
		...
		ExtentTestManagerV5.getTest().log(Status.INFO, "Register - Step 02: Enter to First Name Textbox with value = " + firstName);
//		log.info("Register - Step 02: Enter to First Name Textbox with value = " + firstName);
		registerPage.inputToFirstNameTextbox(firstName);
		
		ExtentTestManagerV5.getTest().log(Status.INFO, "Register - Step 03: Enter to Last Name Textbox with value = " + lastName);
//		log.info("Register - Step 03: Enter to Last Name Textbox with value = " + lastName);
		registerPage.inputToLastNameTextbox(lastName);
		
		
		ExtentTestManagerV5.getTest().log(Status.INFO, "Register - Step 04: Enter to Existing Email Textbox with value = " + existingEmail);
//		log.info("Register - Step 04: Enter to Existing Email Textbox with value = " + existingEmail);
		registerPage.inputToEmailTextbox(existingEmail);
		
		
		ExtentTestManagerV5.getTest().log(Status.INFO, "Register - Step 05: Enter to password Textbox with value = " + password);
//		log.info("Register - Step 05: Enter to password Textbox with value = " + password);
		registerPage.inputToPasswordTextbox(password);
		
		
		ExtentTestManagerV5.getTest().log(Status.INFO, "Register - Step 06: Enter to confirm password  Textbox with value = " + password);
...
//		log.info("Register - Step 07: Click To Register Button");
		...
		ExtentTestManagerV5.getTest().log(Status.INFO, "Register - Step 08: Verify register success message is displyed");
...
//		ExtentTestManagerV5.endTest();
	...
	public void User_02_Login(Method method) {
		...
		ExtentTestManagerV5.getTest().log(Status.INFO, "Login - Step 01: Navigate to open login page");
//		log.info("Login - Step 01: Navigate to open login page");
		loginPage =	homePage.openLoginPage();
		
		
		ExtentTestManagerV5.getTest().log(Status.INFO, "Login - Step 02: Enter to Email Textbox with value = " + existingEmail);
//		log.info("Login - Step 02: Enter to Email Textbox with value = " + existingEmail);
		loginPage.inputToEmailTextbox(existingEmail);
		
		
		
		ExtentTestManagerV5.getTest().log(Status.INFO, "Login - Step 03: Enter to Password Textbox with value = " + password);
...
//		log.info("Login - Step 06: Navigate to my account page");
		...
		ExtentTestManagerV5.getTest().log(Status.INFO, "Login - Step 07: Verify CustomerInfoPage is Displayed");
