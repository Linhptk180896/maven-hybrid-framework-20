...
public class Level17_Share_Custom_Close_Browser extends BaseTest{
	WebDriver driver;
	...
	//-----------CASE 02: TỰ TẠO DATA TRONG CLASS ----------------
	@Parameters("browser")
	@BeforeClass
...
//		basePage = new BasePage(); --> kế thừa BasePage rồi nên không cần khởi tạo
	...
	//Thêm 1 cái annotation alwaysRun = true ở cụm @AfterClass để luôn đóng browser
	//Nhưng thực tế là mới chỉ đóng browser thôi còn driver thì vẫn còn tồn tại trong task manager nên phải viết 1 hàm đóng driver = command line
