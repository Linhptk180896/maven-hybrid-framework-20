...
public class Level03_Register_Apply_BasePage_PageObject_PageGenerator3 extends BasePage{
	WebDriver driver;
...
//		homePage = new HomePageObject(driver); --> Không khởi tạo như này nữa mà gọi qua hàm PageGenerator
