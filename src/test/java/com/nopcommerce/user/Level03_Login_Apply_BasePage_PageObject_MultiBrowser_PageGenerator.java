...
public class Level03_Login_Apply_BasePage_PageObject_MultiBrowser_PageGenerator extends BaseTest{
	WebDriver driver;
...
//		basePage = new BasePage(); --> kế thừa BasePage rồi nên không cần khởi tạo
		...
		//Pre-Condition
		//Bê test case Register successfully từ bên Register sang làm pre-conditon
