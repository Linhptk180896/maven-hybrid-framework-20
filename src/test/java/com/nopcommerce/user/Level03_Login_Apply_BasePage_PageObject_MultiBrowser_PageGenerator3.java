...
public class Level03_Login_Apply_BasePage_PageObject_MultiBrowser_PageGenerator3 extends BaseTest{
	WebDriver driver;
...
//		basePage = new BasePage(); --> kế thừa BasePage rồi nên không cần khởi tạo
		homePage = PageGeneratorManager.getHomePage(driver);
		//Pre-Condition
		//Bên test case Register successfully từ bên Register sang làm pre-conditon
