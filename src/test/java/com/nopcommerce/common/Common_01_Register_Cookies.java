...
//		basePage = new BasePage(); --> kế thừa BasePage rồi nên không cần khởi tạo
		...
		log.info("Pre-Condition - Step 02: Enter to First Name Textbox with value = " + firstName);
		registerPage.inputToFirstNameTextbox(firstName);
		
		log.info("Pre-Condition - Step 03: Enter to Last Name Textbox with value = " + lastName);
		registerPage.inputToLastNameTextbox(lastName);
		
		log.info("Register - Step 04: Enter to Existing Email Textbox with value = " + email);
		registerPage.inputToEmailTextbox(email);
		
		log.info("Pre-Condition - Step 05: Enter to password Textbox with value = " + password);
		registerPage.inputToPasswordTextbox(password);
		
		log.info("Pre-Condition - Step 06: Enter to confirm password  Textbox with value = " + password);
		registerPage.inputToConfirmPasswordTextbox(password);
		
		log.info("Pre-Condition - Step 07: Click To Register Button");
		registerPage.clickToRegisterButton();
		
		log.info("Pre-Condition - Step 08: Verify register success message is displyed");
		verifyEquals(registerPage.getRegisterSuccessMessage(),"Your registration completed...");
		
		log.info("Pre-Condition - Step 09: Click to logout button");
		registerPage.clickToLogoutLink();
	
		log.info("Pre-Condition - Step 01: Navigate to open login page");
		loginPage =	homePage.openLoginPage();
		
		log.info("Pre-Condition - Step 02: Enter to Email Textbox with value = " + email);
		...
		log.info("Pre-Condition - Step 04: Get all cookies after logging in ");
