...
public class ExtentManagerV5 {
	...
	public synchronized static ExtentReports createExtentReports() {
		ExtentSparkReporter reporter = new ExtentSparkReporter(GlobalConstans.PROJECT_PATH + "/extentReportsV5/ExtentReportV5.html");
		...
		extentReports.setSystemInfo("JDK version", GlobalConstans.JAVA_VERSION);
